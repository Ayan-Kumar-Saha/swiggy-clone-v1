...
const RestaurantDetails = () => {
    ...
    useEffect(() => {
        async function fetchRestaurantDetails() {
            const response = await fetch("https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=22.867114&lng=88.3674381&restaurantId=631638&catalog_qa=undefined&submitAction=ENTER");
